function! ruby_ti#ui#setup_highlights()
  let type_info_color = ruby_ti#config#get('type_info_color')
  ...
  if &term ==# 'tmux-256color'
    ...
    execute 'highlight RubyTiTypeInfo ctermfg=' . type_info_color . ' guifg=' . type_info_color . ' cterm=italic gui=italic'
  else
...
function! ruby_ti#ui#show_virtual_text()
  ...
  if ruby_ti#config#get('enable_type_comment', 1)
